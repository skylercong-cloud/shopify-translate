...
面向个人使用的 Shopify 开发文档中文阅读工具。当前已完成单用户访问控制、Shopify.dev 英文文档采集、受保护的后台 AI 翻译流水线，以及独立的中文阅读界面。
...
当前翻译后台已支持 DeepSeek 主用、Qwen 备用、专业术语保护、预算限额、人工修正、后台重译和本地自动化验证。独立中文阅读界面、中英文切换、官方来源链接和未缓存页面按需采集已接入；统一中英文搜索将在后续阶段接入。
